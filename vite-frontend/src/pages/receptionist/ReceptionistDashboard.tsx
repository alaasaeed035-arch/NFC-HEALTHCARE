...
import { Search, UserPlus, Wifi, Stethoscope, Users, ClipboardList, Eye, MapPin, Phone, CreditCard, Contact, RefreshCw, ArrowRight } from 'lucide-react'
...
export default function ReceptionistDashboard() {
  ...
  // Rebuild queue whenever the doctors list changes (doctors loaded = first fetch done)
  useEffect(() => {
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      if (assignedDoc && scannedPatient) {
        setQueue(prev => {
          // avoid duplicate if patient already in this doctor's queue
